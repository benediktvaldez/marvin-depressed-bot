...
controller.hears('do something', ['mention', 'direct_message', 'direct_mention'], function (bot, message) {
  bot.reply(message, 'Here I am, brain the size of a planet, and they tell me to take you down to the bridge. Call that job satisfaction? Cause I don\'t.')
})
...
controller.hears(['what should I do about *', 'fix my problem'], ['mention', 'direct_mention', 'direct_message'], function (bot, message) {
